...
public class DruidConfig {
    ...
    public ServletRegistrationBean druidStatViewServletBean() {
        ...
        //白名单：
        servletRegistrationBean.addInitParameter("allow", "192.168.1.199,192.168.1.188");
        //IP黑名单 (存在共同时，deny优先于allow) : 如果满足deny的话提示:Sorry, you are not permitted to view this page.
//        servletRegistrationBean.addInitParameter("deny", "192.168.0.151");
        //登录查看信息的账号密码.
        servletRegistrationBean.addInitParameter("loginUsername", "kylin");
        servletRegistrationBean.addInitParameter("loginPassword", "kylin");
        //是否能够重置数据.
