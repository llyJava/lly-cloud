...
@EnableSwagger2
public class SwaggerAutoConfiguration implements BeanFactoryAware,WebMvcConfigurer {
    ...
    private List<Parameter> buildGlobalOperationParametersFromSwaggerProperties(
        ...
        //可以添加多个header或参数
        ParameterBuilder aParameterBuilder = new ParameterBuilder(); aParameterBuilder
                .parameterType("header")
                .name("Authorization")
                .description("header中Authorization字段用于认证,值以Bearer开头加空格如:Bearer 35b0252e-a67b-40a3-b8d8-244a9i926cf9")
